...
const chip =
  "inline-flex items-center gap-2.5 rounded-xl border border-white/10 bg-white/[0.03] px-3.5 py-2.5 text-sm font-medium text-nx-soft shadow-[0_0_0_1px_rgba(255,255,255,0.04)_inset] transition hover:border-white/16 hover:bg-white/[0.06] hover:text-white";
